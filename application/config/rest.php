...
|--------------------------------------------------------------------------
|
| The default formsat of the response
|
...
|
*/
$config['rest_auth'] = 'false'; //diubah jadi basic
...
|
*/
$config['auth_source'] = ''; //dikosonhkan
...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234', 'fuji' => 'fn123']; //ditambahkan user baru
...
|
*/
$config['rest_keys_table'] = 'keys'; //buat table di database
...
|
*/
$config['rest_enable_keys'] = FALSE; //diubah jadi true
...
|
*/
$config['rest_key_column'] = 'key'; //nama kolom kunci
...
|
*/
$config['rest_limits_method'] = 'ROUTED_URL'; //pembatasan akses
...
|
*/
$config['rest_key_length'] = 40; //panjang kunci
...
|
*/
$config['rest_key_name'] = 'fn_key'; //nama key 
...
*/
$config['rest_enable_limits'] = TRUE; //aktifasi limit
